...
{
    public partial class Form_camp : Form
    {
        ...
        public Form_camp(int Gamma, int Back)
        {
            InitializeComponent();
        ...
        private void Form_camp_Load(object sender, EventArgs e)
        {
            int cameraIndex = 0;
            // check format.
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            timer1.Stop();
            camera.Stop();
            Form_camp2 FC2 = new Form_camp2(trackBar1.Value, trackBar2.Value);
            FC2.Show();
        ...
        private void Form_camp_FormClosing(object sender, FormClosingEventArgs e)
        {
            /*Form_camp FP = new Form_camp(trackBar1.Value, trackBar2.Value);
            FP.Show();*/
        }
    }
}
